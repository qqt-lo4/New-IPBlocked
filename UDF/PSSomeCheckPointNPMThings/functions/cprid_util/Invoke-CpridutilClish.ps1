function Invoke-CpridutilClish {
    Param(
        [AllowNull()]
    ...
    $oCpridutilResult = Invoke-Cpridutil -ManagementInfo $ManagementInfo -Firewall $Firewall -Shell "clish" -Script $Script -WaitProgressMessage $WaitProgressMessage -Timeout $Timeout
